...
\lstinputlisting[firstline=2, lastline=2]{howToLatex}%\RequirePackage
...
\lstinputlisting[firstline=4, lastline=4]{howToLatex}%\documentclass
...
\lstinputlisting[firstline=5, lastline=5]{howToLatex}%\documentclass
